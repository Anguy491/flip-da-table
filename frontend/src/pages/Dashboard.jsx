		...
		<PageContainer>
			<CardContainer className="max-w-xl">
				...
				<div className="flex gap-4 justify-center">
					<SubmitButton type="button" onClick={openModal}>Create Session</SubmitButton>
					<SubmitButton type="button" className="btn-secondary" onClick={handleLogout}>Logout</SubmitButton>
				</div>
